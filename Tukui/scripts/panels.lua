...
TukuiDB.CreatePanel(chatleft, TukuiCF["panels"].tinfowidth, TukuiDB.Scale(136), "BOTTOM", TukuiInfoLeft, "TOP", 0, TukuiDB.Scale(4))
chatleft:SetBackdropColor(.075,.075,.075,.7)

-- CHAT RIGHT
local chatright = CreateFrame("Frame", "ChatRight", TukuiInfoRight)
TukuiDB.CreatePanel(chatright, TukuiCF["panels"].tinfowidth, TukuiDB.Scale(136), "BOTTOM", TukuiInfoRight, "TOP", 0, TukuiDB.Scale(4))
