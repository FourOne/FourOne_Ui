...
function TukuiDB.PP(p, obj)
	...
	elseif p == 2 then
		obj:SetHeight(left:GetHeight())
		obj:SetPoint("LEFT", left, 130, 0)
		obj:SetPoint('TOP', left)
		obj:SetPoint('BOTTOM', left)
	elseif p == 3 then
		obj:SetHeight(left:GetHeight())
		obj:SetPoint("RIGHT", left, -130, 0)
		obj:SetPoint('TOP', left)
		obj:SetPoint('BOTTOM', left)
	elseif p == 4 then
	...
	elseif p == 6 then
		obj:SetHeight(right:GetHeight())
		obj:SetPoint("LEFT", right, 130, 0)
		obj:SetPoint('TOP', right)
		obj:SetPoint('BOTTOM', right)
	elseif p == 7 then
		obj:SetHeight(right:GetHeight())
		obj:SetPoint("RIGHT", right, -130, 0)
		obj:SetPoint('TOP', right)
		obj:SetPoint('BOTTOM', right)
	elseif p == 8 then
		obj:SetHeight(right:GetHeight())
...
do
	...
	function TukuiDB.PostCreateAura(element, button)
		...
		button.remaining = TukuiDB.SetFontString(button, TukuiCF["media"].uffont, TukuiCF["unitframes"].auratextscale, "THINOUTLINE")
		...
		button.count:SetFont(TukuiCF["media"].uffont, 9, "THICKOUTLINE")
	...
	TukuiDB.EclipseDisplay = function(self, login)
		...
		if eb:IsShown() then
			if self.Buffs then self.Buffs:SetPoint("TOPLEFT", self, "TOPLEFT", -2, 48) end			
		else
			if self.Buffs then self.Buffs:SetPoint("TOPLEFT", self, "TOPLEFT", -2, 32) end
		end
	end
